...
Public Class Form2
    ...
    Dim rnd As New Random 'Oppretter er random
    Dim path As String = My.Resources.ordliste_random
    ' C:\Users\Miner2\OneDrive - NTNU\IFUD1105 Teamarbeid\Team7-Hangman-KneeCapz-patch-3 (1)\Team7-Hangman-KneeCapz-patch-3\Hangman\Resources\ordliste_random.txt
    Dim sr As StreamReader 'Starter opp StreamReader. Den skal lese tekstfila.
    Dim line As String
    ...
    Private Sub Random_Click(sender As Object, e As EventArgs) Handles Random.Click
        ...
        Dim path As String = My.Resources.ordliste_random
        Dim ord As String() = IO.File.ReadAllLines(path)

        'C:\Users\Miner2\OneDrive - NTNU\IFUD1105 Teamarbeid\Team7-Hangman-KneeCapz-patch-3 (1)\Team7-Hangman-KneeCapz-patch-3\Hangman\Resources\ordliste_random.txt

        Dim rnd As New Random()

        Dim selectedIndex = rnd.Next(0, ord.Length) 'Velger en tilfeldig index
